...
//==============================================================================
void LookNFeel::drawButtonBackground (Graphics& g,
                                           Button& button,
...
Font LookNFeel::getTextButtonFont (TextButton&, int buttonHeight)
{
    return Font (jmin (15.0f, buttonHeight * 0.6f));
}

int LookNFeel::getTextButtonWidthToFitText (TextButton& b, int buttonHeight)
{
    return getTextButtonFont (b, buttonHeight).getStringWidth (b.getButtonText()) + buttonHeight;
}

void LookNFeel::drawButtonText (Graphics& g, TextButton& button, bool /*isMouseOverButton*/, bool /*isButtonDown*/)
{
...
void LookNFeel::drawTickBox (Graphics& g, Component& component,
...
void LookNFeel::drawToggleButton (Graphics& g, ToggleButton& button,
                                       bool isMouseOverButton, bool isButtonDown)
{
    ...
    g.drawFittedText (button.getButtonText(),
                      textX, 0,
                      jmax(0,button.getWidth() - textX - 2), button.getHeight(),
                      Justification::centredLeft, 10);
}

void LookNFeel::changeToggleButtonWidthToFitText (ToggleButton& button)
{
...
void LookNFeel::drawDrawableButton (Graphics& g, DrawableButton& button,
                                         bool /*isMouseOverButton*/, bool /*isButtonDown*/)
{
...
//==============================================================================
AlertWindow* LookNFeel::createAlertWindow (const String& title, const String& message,
...
void LookNFeel::drawAlertBox (Graphics& g, AlertWindow& alert,
...
int LookNFeel::getAlertBoxWindowFlags()
{
    return ComponentPeer::windowAppearsOnTaskbar
    | ComponentPeer::windowHasDropShadow;
}

int LookNFeel::getAlertWindowButtonHeight()
{
    return 28;
}

Font LookNFeel::getAlertWindowTitleFont()
{
    Font messageFont = getAlertWindowMessageFont();
    return messageFont.withHeight (messageFont.getHeight() * 1.1f).boldened();
}

Font LookNFeel::getAlertWindowMessageFont()
{
    return Font (15.0f);
}

Font LookNFeel::getAlertWindowFont()
{
    return Font (12.0f);
}

//==============================================================================
void LookNFeel::drawProgressBar (Graphics& g, ProgressBar& progressBar,
...
void LookNFeel::drawSpinningWaitAnimation (Graphics& g, const Colour& colour, int x, int y, int w, int h)
{
...
bool LookNFeel::areScrollbarButtonsVisible()
{
    return true;
}

void LookNFeel::drawScrollbarButton (Graphics& g, ScrollBar& scrollbar,
...
void LookNFeel::drawScrollbar (Graphics& g,
                                    ScrollBar& scrollbar,
                                    int x, int y,
                                    int width, int height,
                                    bool isScrollbarVertical,
...
ImageEffectFilter* LookNFeel::getScrollbarEffect()
{
    return nullptr;
}

int LookNFeel::getMinimumScrollbarThumbSize (ScrollBar& scrollbar)
{
    return jmin (scrollbar.getWidth(), scrollbar.getHeight()) * 2;
}

int LookNFeel::getDefaultScrollbarWidth()
{
    return 18;
}

int LookNFeel::getScrollbarButtonSize (ScrollBar& scrollbar)
{
...
//==============================================================================
Path LookNFeel::getTickShape (const float height)
{
...
Path LookNFeel::getCrossShape (const float height)
{
...
//==============================================================================
void LookNFeel::drawTreeviewPlusMinusBox (Graphics& g, const Rectangle<float>& area,
...
bool LookNFeel::areLinesDrawnForTreeView (TreeView&)
{
    return true;
}

int LookNFeel::getTreeViewIndentSize (TreeView&)
{
    return 24;
}

//==============================================================================
void LookNFeel::drawBubble (Graphics& g, BubbleComponent& comp,
...
void LookNFeel::getIdealPopupMenuItemSize (const String& text, const bool isSeparator,
...
void LookNFeel::drawPopupMenuUpDownArrow (Graphics& g, int width, int height, bool isScrollUpArrow)
{
    const Colour background (findColour (PopupMenu::backgroundColourId));
...
void LookNFeel::drawPopupMenuItem (Graphics& g, const Rectangle<int>& area,
...
void LookNFeel::drawPopupMenuSectionHeader (Graphics& g, const Rectangle<int>& area, const String& sectionName)
{
...
void LookNFeel::drawMenuBarBackground (Graphics& g, int width, int height, bool, MenuBarComponent& menuBar)
{
...
Font LookNFeel::getMenuBarFont (MenuBarComponent& menuBar, int /*itemIndex*/, const String& /*itemText*/)
{
    return Font (menuBar.getHeight() * 0.7f);
}

int LookNFeel::getMenuBarItemWidth (MenuBarComponent& menuBar, int itemIndex, const String& itemText)
{
    return getMenuBarFont (menuBar, itemIndex, itemText)
    .getStringWidth (itemText) + menuBar.getHeight();
}

void LookNFeel::drawMenuBarItem (Graphics& g, int width, int height,
...
//==============================================================================
void LookNFeel::fillTextEditorBackground (Graphics& g, int /*width*/, int /*height*/, TextEditor& textEditor)
{
    g.fillAll (textEditor.findColour (TextEditor::backgroundColourId));
}

void LookNFeel::drawTextEditorOutline (Graphics& g, int width, int height, TextEditor& textEditor)
{
...
CaretComponent* LookNFeel::createCaretComponent (Component* keyFocusOwner)
{
    return new CaretComponent (keyFocusOwner);
}

//==============================================================================
void LookNFeel::drawComboBox (Graphics& g, int width, int height, const bool isButtonDown,
...
Font LookNFeel::getComboBoxFont (ComboBox& box)
{
    return Font (jmin (15.0f, box.getHeight() * 0.85f));
}

Label* LookNFeel::createComboBoxTextBox (ComboBox&)
{
    return new Label (String::empty, String::empty);
}

void LookNFeel::positionComboBoxText (ComboBox& box, Label& label)
{
    label.setBounds (1, 1,
...
//==============================================================================
Font LookNFeel::getLabelFont (Label& label)
{
    return label.getFont();
}

void LookNFeel::drawLabel (Graphics& g, Label& label)
{
...
//==============================================================================
void LookNFeel::drawLinearSliderBackground (Graphics& g, int x, int y, int width, int height,
                                                 float /*sliderPos*/,
                                                 float /*minSliderPos*/,
                                                 float /*maxSliderPos*/,
...
void LookNFeel::drawLinearSlider (Graphics& g, int x, int y, int width, int height,
                                       float sliderPos, float minSliderPos, float maxSliderPos,
                                       const Slider::SliderStyle style, Slider& slider)
{
...
int LookNFeel::getSliderThumbRadius (Slider& slider)
{
    return jmin (7,
                 slider.getHeight() / 2,
                 slider.getWidth() / 2) + 2;
...
Button* LookNFeel::createSliderButton (Slider&, const bool isIncrement)
{
    return new TextButton (isIncrement ? "+" : "-", String::empty);
}

class LookNFeel::SliderLabelComp  : public Label
{
public:
...
Label* LookNFeel::createSliderTextBox (Slider& slider)
{
...
ImageEffectFilter* LookNFeel::getSliderEffect (Slider&)
{
    return nullptr;
}

Font LookNFeel::getSliderPopupFont (Slider&)
{
    return Font (15.0f, Font::bold);
}

int LookNFeel::getSliderPopupPlacement (Slider&)
{
...
//==============================================================================
Slider::SliderLayout LookNFeel::getSliderLayout (Slider& slider)
{
...
//==============================================================================
Rectangle<int> LookNFeel::getTooltipBounds (const String& tipText, Point<int> screenPos, Rectangle<int> parentArea)
{
...
void LookNFeel::drawTooltip (Graphics& g, const String& text, int width, int height)
{
...
//==============================================================================
Button* LookNFeel::createFilenameComponentBrowseButton (const String& text)
{
    return new TextButton (text, TRANS("click to browse for a different file"));
}

void LookNFeel::layoutFilenameComponent (FilenameComponent& filenameComp,
...
//==============================================================================
void LookNFeel::drawConcertinaPanelHeader (Graphics& g, const Rectangle<int>& area,
...
//==============================================================================
void LookNFeel::drawImageButton (Graphics& g, Image* image,
...
//==============================================================================
void LookNFeel::drawCornerResizer (Graphics& g,
                                        int w, int h,
                                        bool /*isMouseOver*/,
...
void LookNFeel::drawResizableFrame (Graphics& g, int w, int h, const BorderSize<int>& border)
{
    if (! border.isEmpty())
    {
...
//==============================================================================
void LookNFeel::fillResizableWindowBackground (Graphics& g, int /*w*/, int /*h*/,
                                                    const BorderSize<int>& /*border*/, ResizableWindow& window)
{
    g.fillAll (window.getBackgroundColour());
}

void LookNFeel::drawResizableWindowBorder (Graphics&, int /*w*/, int /*h*/,
                                                const BorderSize<int>& /*border*/, ResizableWindow&)
{
}

void LookNFeel::drawDocumentWindowTitleBar (DocumentWindow& window, Graphics& g,
...
//==============================================================================
class LookNFeel::GlassWindowButton   : public Button
{
public:
    ...
    void paintButton (Graphics& g, bool isMouseOverButton, bool isButtonDown) override
    {
        ...
        LookNFeel::drawGlassSphere (g, x, y, diam, colour.withAlpha (alpha), 1.0f);
...
Button* LookNFeel::createDocumentWindowButton (int buttonType)
{
    Path shape;
...
void LookNFeel::positionDocumentWindowButtons (DocumentWindow&,
...
int LookNFeel::getDefaultMenuBarHeight()
{
    return 24;
}

//==============================================================================
DropShadower* LookNFeel::createDropShadowerForComponent (Component*)
{
    return new DropShadower (DropShadow (Colours::black.withAlpha (0.4f), 10, Point<int> (0, 2)));
}

//==============================================================================
void LookNFeel::drawStretchableLayoutResizerBar (Graphics& g, int w, int h,
                                                      bool /*isVerticalBar*/,
                                                      bool isMouseOver,
                                                      bool isMouseDragging)
{
...
//==============================================================================
void LookNFeel::drawGroupComponentOutline (Graphics& g, int width, int height,
...
//==============================================================================
int LookNFeel::getTabButtonOverlap (int tabDepth)
{
    return 1 + tabDepth / 3;
}

int LookNFeel::getTabButtonSpaceAroundImage()
{
    return 4;
}

int LookNFeel::getTabButtonBestWidth (TabBarButton& button, int tabDepth)
{
...
Rectangle<int> LookNFeel::getTabButtonExtraComponentBounds (const TabBarButton& button, Rectangle<int>& textArea, Component& comp)
{
...
void LookNFeel::createTabButtonShape (TabBarButton& button, Path& p, bool /*isMouseOver*/, bool /*isMouseDown*/)
{
...
void LookNFeel::fillTabButtonShape (TabBarButton& button, Graphics& g, const Path& path,
                                         bool /*isMouseOver*/, bool /*isMouseDown*/)
{
...
void LookNFeel::drawTabButtonText (TabBarButton& button, Graphics& g, bool isMouseOver, bool isMouseDown)
{
...
void LookNFeel::drawTabButton (TabBarButton& button, Graphics& g, bool isMouseOver, bool isMouseDown)
{
    Path tabShape;
...
void LookNFeel::drawTabbedButtonBarBackground (TabbedButtonBar&, Graphics&) {}

void LookNFeel::drawTabAreaBehindFrontButton (TabbedButtonBar& bar, Graphics& g, const int w, const int h)
{
...
Button* LookNFeel::createTabBarExtrasButton()
{
...
//==============================================================================
void LookNFeel::drawTableHeaderBackground (Graphics& g, TableHeaderComponent& header)
{
...
void LookNFeel::drawTableHeaderColumn (Graphics& g, const String& columnName, int /*columnId*/,
...
//==============================================================================
void LookNFeel::drawLasso (Graphics& g, Component& lassoComp)
{
...
//==============================================================================
void LookNFeel::paintToolbarBackground (Graphics& g, int w, int h, Toolbar& toolbar)
{
...
Button* LookNFeel::createToolbarMissingItemsButton (Toolbar& /*toolbar*/)
{
    return createTabBarExtrasButton();
}

void LookNFeel::paintToolbarButtonBackground (Graphics& g, int /*width*/, int /*height*/,
                                                   bool isMouseOver, bool isMouseDown,
...
void LookNFeel::paintToolbarButtonLabel (Graphics& g, int x, int y, int width, int height,
...
//==============================================================================
void LookNFeel::drawPropertyPanelSectionHeader (Graphics& g, const String& name,
...
void LookNFeel::drawPropertyComponentBackground (Graphics& g, int width, int height, PropertyComponent& component)
{
    g.setColour (component.findColour (PropertyComponent::backgroundColourId));
    g.fillRect (0, 0, width, height - 1);
}

void LookNFeel::drawPropertyComponentLabel (Graphics& g, int, int height, PropertyComponent& component)
{
...
Rectangle<int> LookNFeel::getPropertyComponentContentPosition (PropertyComponent& component)
{
...
//==============================================================================
void LookNFeel::drawCallOutBoxBackground (CallOutBox& box, Graphics& g,
...
int LookNFeel::getCallOutBoxBorderSize (const CallOutBox&)
{
    return 20;
}

//==============================================================================
AttributedString LookNFeel::createFileChooserHeaderText (const String& title,
...
void LookNFeel::drawFileBrowserRow (Graphics& g, int width, int height,
...
Button* LookNFeel::createFileBrowserGoUpButton()
{
...
void LookNFeel::layoutFileBrowserComponent (FileBrowserComponent& browserComp,
...
const Drawable* LookNFeel::getDefaultFolderImage()
{
...
const Drawable* LookNFeel::getDefaultDocumentFileImage()
{
...
//==============================================================================
void LookNFeel::drawLevelMeter (Graphics& g, int width, int height, float level)
{
...
//==============================================================================
void LookNFeel::drawKeymapChangeButton (Graphics& g, int width, int height, Button& button, const String& keyDescription)
{
...
//==============================================================================
void LookNFeel::drawBevel (Graphics& g, const int x, const int y, const int width, const int height,
...
//==============================================================================
void LookNFeel::drawShinyButtonShape (Graphics& g,
                                           float x, float y, float w, float h,
                                           float maxCornerSize,
...
//==============================================================================
void LookNFeel::drawGlassSphere (Graphics& g, const float x, const float y,
...
//==============================================================================
void LookNFeel::drawGlassPointer (Graphics& g,
...
//==============================================================================
void LookNFeel::drawGlassLozenge (Graphics& g,
