...
#ifndef JUCE_LOOKNFEEL_H_INCLUDED
#define JUCE_LOOKNFEEL_H_INCLUDED
 ...
 */
class   LookNFeel  : public LookAndFeel
{
public:
    LookNFeel();
    ~LookNFeel();
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (LookNFeel)
};


#endif   // JUCE_LookNFeel_H_INCLUDED
